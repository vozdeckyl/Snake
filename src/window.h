...
/*!
    ...
    The class holds a list of all drawables and also has a point to the graphics engine which is used for drawing on the screen.
*/
class Window {
    public:
        /*!
        ...
        */
        ...
        /*!
            @brief Function that needs to be run to launch the screen. The function returns the %result of the window and when user exits.
        */
        Result run();
    ...
    private:
        /*!
            @brief This function is run on a separate thread. It iterates through the drawable objects and calls draw functions on them.
            It also takes care of the user input.
        */
        void graphicsLoop();

        /*!
            @brief This function is run on a separate thread. It iterates through the drawables, notifies them and sleeps for a short interval (1ms). 
        */
        void updateLoop();
